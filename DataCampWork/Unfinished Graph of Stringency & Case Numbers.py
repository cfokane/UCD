...
RDCDStringL45 = pd.read_csv('RDCD2.csv')
print(RDCDStringL45.columns)
RDCDStringL45q=RDCDStringL45.loc[:,['Week_Num', 'Stringency_Indexed', 'Weekly_Cases', 'Weekly_Deaths']]
RDCDStringL45qSL5=RDCDStringL45q['Stringency_Indexed'].isin(['4'])
#Is_brown_or_black = dogs[‘colour’].isin([‘brown’, ‘black’])

print(RDCDStringL45q)
print(RDCDStringL45qSL5)
#data = pd.read_csv('StringL5WkTot.csv', index_col=0)
#print(data)

fig, ax =plt.subplots()
#ax.plot(data['All'], label='Weekly Deaths')
